                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      {/* Card Body */}
                      <div className="mt-4 space-y-2 text-sm text-blue-muted">
                    ...
                    <div className="mt-4 pt-4 border-t border-blue-pale flex justify-between items-center text-xs">
                      <span className="text-blue-muted">ID: {member.id.substring(0, 8)}...</span>
